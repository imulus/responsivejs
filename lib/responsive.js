...
(function() {
  ...
  window._R_ = (function() {
    ...
    _R_.prototype.from = function(stop, callback) {
      ...
      if (this.from_callbacks[stop] == null) {
        this.from_callbacks[stop] = [];
      }
      return this.from_callbacks[stop].push(callback);
    };
    ...
    _R_.prototype.into = function(stop, callback) {
      ...
      if (this.into_callbacks[stop] == null) {
        this.into_callbacks[stop] = [];
      }
      return this.into_callbacks[stop].push(callback);
    };
